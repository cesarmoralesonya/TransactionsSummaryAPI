...
namespace IntegrationTests.ApiClients.TransactionClientTests
{
    public class GetAll
    {
        ...
        public GetAll(ITestOutputHelper output)
        {
            ...
            _rateClient = new TransactionClient(mockFactory.Object, loggerMockClient.Object, configuration);
        }
